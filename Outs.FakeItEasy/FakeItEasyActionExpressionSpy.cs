...
public class FakeItEasyActionExpressionSpy : FakeItEasySpy
{
    internal readonly Expression<Action> expr;

    internal FakeItEasyActionExpressionSpy(Expression<Action> expr)
    {
        this.expr = expr;
    }
